...
.data 
    FilePath: .asciiz "C:\\Users\\danie\\OneDrive - Universidade Estadual de Londrina\\Área de Trabalho\\CrusosUEL\\Faculdade UEL\\SegundoAnoSegundoBi\\ArqComp-II\\Atividade8\\primos_gemeos.txt"
    string: .space 2048
.text
