...
.data
	...
	FilePath: .asciiz "C:\\Users\\danie\\OneDrive - Universidade Estadual de Londrina\\Área de Trabalho\\CrusosUEL\\Faculdade UEL\\SegundoAnoSegundoBi\\ArqComp-II\\Atividade9\\dados2.txt"
	Buffer: .asciiz " "
	vetor: .space 512
.text
