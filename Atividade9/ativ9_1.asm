...
.data
	...
	FilePath: .asciiz "C:\\Users\\danie\\OneDrive - Universidade Estadual de Londrina\\Área de Trabalho\\CrusosUEL\\Faculdade UEL\\SegundoAnoSegundoBi\\ArqComp-II\\Atividade9\\dados1.txt"
	Buffer: .asciiz " "
	vetor: .space 512
.text
	...
	fscanf:
		...
		read:
			...
			to_int:
				...
				li $v0, 14
				syscall
				beqz $v0, save_number # (if EOF goto save_number and then return_eof)				
